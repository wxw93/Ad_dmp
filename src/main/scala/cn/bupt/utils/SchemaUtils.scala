...
object SchemaUtils {
  ...
  val logAppType = StructType(Seq(
    StructField("appName",StringType),
    StructField("allReqNum",DoubleType),
    StructField("validReqNum",DoubleType),
    StructField("adReqNum",DoubleType),
    StructField("bidNum",DoubleType),
    StructField("bidSuccessNum",DoubleType),
    StructField("showNum",DoubleType),
    StructField("clickNum",DoubleType),
    StructField("asCost",DoubleType),
    StructField("adConsume",DoubleType)
  ))
}
